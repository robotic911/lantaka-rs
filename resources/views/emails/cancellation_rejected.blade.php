<!DOCTYPE html>
<html lang="en">
<head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Cancellation Request Rejected</title>
<style>
...
.banner{background:#fef2f2;border-bottom:3px solid #ef4444;padding:14px 40px;text-align:center;font-size:14px;font-weight:700;color:#991b1b;letter-spacing:.3px}
...
.status-chip{display:inline-block;background:#fef2f2;border:1px solid #ef4444;color:#991b1b;padding:3px 12px;border-radius:20px;font-size:13px;font-weight:700}
.note-box{background:#fef2f2;border-left:4px solid #ef4444;padding:14px 18px;border-radius:0 6px 6px 0;margin:20px 0;font-size:13px;color:#7f1d1d}
.note-box strong{display:block;margin-bottom:4px;font-size:12px;text-transform:uppercase;letter-spacing:.5px;color:#991b1b}
...
<div class="wrap">
  ...
  <div class="banner">
    <span class="banner-icon">✕</span> Cancellation Request Rejected
  </div>

  <div class="body">
    <p>Hello, <strong>{{ $reservation->user->Account_Name ?? 'Guest' }}</strong>.</p>
    <p>We have reviewed your cancellation request and unfortunately it has been <strong>rejected</strong>. Your reservation remains active as originally confirmed.</p>
    ...
    <div class="detail-box">
      ...
      <div class="detail-row">
        ...
        <span class="detail-value"><span class="status-chip">Rejected</span></span>
      </div>
    ...
    <div class="info">
      If you have any questions or concerns, please contact us at <strong>lantaka@adzu.edu.ph</strong>.
    </div>

    <p>Thank you for your understanding.<br><strong>Lantaka Reservation System Team</strong></p>
  </div>
