<!DOCTYPE html>
<html lang="en">
<head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Reservation Cancelled</title>
<style>
...
.banner{background:#fee2e2;border-bottom:3px solid #f87171;padding:14px 40px;text-align:center;font-size:14px;font-weight:700;color:#991b1b;letter-spacing:.3px}
...
.info{background:#fff8f8;border-left:4px solid #f87171;padding:14px 18px;border-radius:0 6px 6px 0;margin:20px 0;font-size:13px;color:#7f1d1d}
